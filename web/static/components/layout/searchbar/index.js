      ...
      <div class="container-fluid nav-search-bar">
        <div class="d-flex flex-row flex-grow-1 align-items-center py-1">
          ...
          <div class="input-group input-group-flat mx-2">
            ...
            <input type="text" class="home_search_bar form-control form-control-rounded" placeholder=${this._search_source === "person" ? "搜索人物" : "搜索电影、电视剧"} autocomplete="new-password" ?readonly=${this.layout_userlevel < 2 && this.layout_useradmin !== "1"}
              @keypress=${ (e) => {
            ...
            <span class="input-group-text form-control-rounded">
              <a href="${this.layout_userlevel > 1 && this.layout_useradmin !== "1" ? "javascript:show_search_advanced_modal()":"javascript:void(0)"}" class="link-secondary">
